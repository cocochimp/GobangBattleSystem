...
public class ChatClient02 implements ActionListener{
    String name = null;
    Socket client = null;
    JFrame jf = null;
    JTextArea jta = null;  //多行文本域
    JTextField jtf = null;
    JScrollPane jsp = null;
    JButton btnSend = null;
    JComboBox jcb = null; //下拉框
...
class clientReader02 extends Thread{
    DataInputStream dis = null;
    JTextArea jta = null;
    JComboBox jcb = null;
    public clientReader02(DataInputStream dis,JTextArea jta,JComboBox jcb) {
        this.dis = dis;
        this.jta = jta;
        this.jcb = jcb;
    }
